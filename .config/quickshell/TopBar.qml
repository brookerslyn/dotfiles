...
Variants {
    ...
    delegate: Component {
	    ...
	    Caching { id: paths }
            ...
            property bool hamburgerOpen: false
		...
		running: true
            ...
            Item {
                ...
                Rectangle {
                    ...
                    height: barWindow.barHeight; width: barWindow.s(34)
                    y: (parent.height - barWindow.barHeight) / 2
                    x: barWindow.s(4)
                    Text { anchors.centerIn: parent; text: "☰"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(18); color: hamMa.containsMouse ? mocha.mauve : mocha.text; Behavior on color { ColorAnimation { duration: 150 } } }
                    MouseArea { id: hamMa; anchors.fill: parent; hoverEnabled: true; onClicked: Quickshell.execDetached(["rofi", "-show", "drun"]) }
                }
                Rectangle {
                    id: workspacesBox
                    color: Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.55)
                    radius: barWindow.s(14); border.width: 0; border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.05)
                    ...
                    property real defaultX: hamburgerBtn.x + hamburgerBtn.width + barWindow.s(4)
                    ...
                    Rectangle {
                        ...
                        // Calculate step size to perfectly match the rounded width + rounded spacing of the Row elements.
                        property real stepSize: barWindow.s(28) + barWindow.s(6)
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                height: barWindow.s(28); radius: barWindow.s(8)
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    onClicked: Quickshell.execDetached(["hyprctl", "dispatch", "workspace", wsName])
                                }
                            }
                        }
                    }
                ...
                Rectangle {
                    ...
                    property real defaultX: workspacesBox.x + workspacesBox.width + barWindow.s(4)
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                onClicked: barWindow.showMusicPopup = !barWindow.showMusicPopup
                            ...
                            Row {
                                ...
                                Item { 
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    Text { 
                                        anchors.centerIn: parent; text: "󰒮"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(26); 
                                        color: prevMouse.containsMouse ? mocha.text : mocha.overlay2; 
                                        Behavior on color { ColorAnimation { duration: 150 } }
                                        scale: prevMouse.containsMouse ? 1.1 : 1.0
                                        Behavior on scale { NumberAnimation { duration: 200; easing.type: Easing.OutBack } }
                                    }
                                    MouseArea { id: prevMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached(["playerctl", "--ignore-player=firefox,chromium", "previous"]); musicForceRefresh.running = true; } } 
                                }
                                Item { 
                                    width: barWindow.s(28); height: barWindow.s(28); 
                                    anchors.verticalCenter: parent.verticalCenter
                                    Text { 
                                        anchors.centerIn: parent; text: barWindow.musicData.status === "Playing" ? "󰏤" : "󰐊"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(30); 
                                        color: playMouse.containsMouse ? mocha.green : mocha.text; 
                                        Behavior on color { ColorAnimation { duration: 150 } }
                                        scale: playMouse.containsMouse ? 1.15 : 1.0
                                        Behavior on scale { NumberAnimation { duration: 200; easing.type: Easing.OutBack } }
                                    }
                                    MouseArea { id: playMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached(["playerctl", "--ignore-player=firefox,chromium", "play-pause"]); musicForceRefresh.running = true; } } 
                                }
                                Item { 
                                    width: barWindow.s(24); height: barWindow.s(24); 
                                    anchors.verticalCenter: parent.verticalCenter
                                    Text { 
                                        anchors.centerIn: parent; text: "󰒭"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(26); 
                                        color: nextMouse.containsMouse ? mocha.text : mocha.overlay2; 
                                        Behavior on color { ColorAnimation { duration: 150 } }
                                        scale: nextMouse.containsMouse ? 1.1 : 1.0
                                        Behavior on scale { NumberAnimation { duration: 200; easing.type: Easing.OutBack } }
                                    }
                                    MouseArea { id: nextMouse; hoverEnabled: true; anchors.fill: parent; onClicked: { Quickshell.execDetached(["playerctl", "--ignore-player=firefox,chromium", "next"]); musicForceRefresh.running = true; } } 
                                }
                            }
                        }
                    }
                ...
                Rectangle {
                    ...
                    color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.95) : Qt.rgba(mocha.base.r, mocha.base.g, mocha.base.b, 0.55)
                    radius: barWindow.s(14); border.width: 0; border.color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, isHovered ? 0.15 : 0.05)
                    ...
                    property real pureCenter: workspacesBox.x + workspacesBox.width + barWindow.s(4)
                    ...
                    property real defaultX: minCenterDefaultX
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            spacing: -2
                            Text { text: barWindow.timeStr; Layout.alignment: Qt.AlignLeft; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(16); font.weight: Font.Black; color: mocha.mauve }
                            Text { text: barWindow.dateStr; Layout.alignment: Qt.AlignLeft; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(11); font.weight: Font.Bold; color: mocha.subtext0; visible: centerBox.isHovered }
                        }
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    anchors.leftMargin: barWindow.s(12)
                                    spacing: barWindow.s(8)
                                    Text { anchors.verticalCenter: parent.verticalCenter; text: "󰌌"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(16); color: parent.parent.isHovered ? mocha.text : mocha.overlay2 }
                                    Text { anchors.verticalCenter: parent.verticalCenter; text: barWindow.kbLayout; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(13); font.weight: Font.Black; color: mocha.text }
                                }
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(16);
                                    ...
                                    Text { 
                                        ...
                                        visible: false
                                        font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(13); font.weight: Font.Black;
                                ...
                                MouseArea { id: wifiMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["nm-connection-editor"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                color: isHovered ? Qt.rgba(mocha.surface1.r, mocha.surface1.g, mocha.surface1.b, 0.6) : "transparent"
                                radius: barWindow.s(10); height: sysLayout.pillHeight; width: barWindow.s(34)
                                Behavior on color { ColorAnimation { duration: 200 } }
                                Text { anchors.centerIn: parent; text: "󰂜"; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(16); color: parent.isHovered ? mocha.mauve : mocha.text }
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: barWindow.volIcon; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(16); 
                            ...
                            Rectangle {
                                ...
                                Row { 
                                    ...
                                    Text { 
                                        ...
                                        font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.isDesktop ? barWindow.s(18) : barWindow.s(16); 
                                        color: mocha.base 
                                    ...
                                    Text { 
                                        ...
                                        text: barWindow.batPercent; font.family: "JetBrainsMono Nerd Font Propo"; font.pixelSize: barWindow.s(13); font.weight: Font.Black; 
                                        color: mocha.base 
                                        Behavior on color { ColorAnimation { duration: 300 } }
                                    }
                                }
                                MouseArea { id: batMouse; hoverEnabled: true; anchors.fill: parent; onClicked: {} }
                            }                       
                 }
            }
            Rectangle {
            ...
            PopupWindow {
                id: musicPopup
                visible: barWindow.showMusicPopup
                anchor.window: barWindow
                anchor.item: mediaBox
                anchor.edges: Edges.Bottom
                anchor.gravity: Edges.Bottom
                implicitWidth: 300
                implicitHeight: 180
                color: "transparent"
                Music.MusicPopup { anchors.fill: parent }
            }
                    }
                }
            }
