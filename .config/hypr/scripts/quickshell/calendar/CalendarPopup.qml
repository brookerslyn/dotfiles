...
Item {
    ...
    function setWeatherView(idx) {
        ...
        // If an animation is already running, interrupt it and apply the logical switch
    ...
    Item {
        ...
        Rectangle {
            ...
            Item {
                ...
                // Moved scale property out of the onPaint function to prevent redrawing every frame.
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    // Replaced explicit widths and manual vertical anchors with flexible ColumnLayout containers
                    RowLayout {
                        Layout.fillWidth: true
                        Layout.alignment: Qt.AlignHCenter 
                        ...
                        Repeater {
                            ...
                            Item {
                                ...
                                // Use ColumnLayout to enforce perfect relative positioning instead of absolute anchors
                                ColumnLayout {
                                    anchors.centerIn: parent
            ...
            Item {
                ...
                // Separated the massive continuous Canvas path-drawing loop into three pre-rendered hardware-accelerated static layers.
                Item {
                    anchors.fill: parent
                    z: -1
                    opacity: 0.15
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text { 
                            Layout.fillWidth: true // Ensures text shrinks/elides instead of expanding layout infinitely
