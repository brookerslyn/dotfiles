...
Item {
    ...
    // Added missing iconFont property to prevent 'undefined to QString' warnings
    ...
    // Strict color resolution to prevent undefined QString warnings
    ...
    Item {
        ...
        Item {
            ...
            PinchHandler {
                ...
                enabled: root.isActiveTab // Isolated Input
            ...
            Item {
                ...
                DragHandler {
                    target: zoomContainer
                    enabled: root.currentTool === "mouse" && root.isActiveTab // Isolated Input
        ...
        Rectangle {
            ...
            Column {
                ...
                // Quick Swatches
                // Null checks for mochaColors properties
                Grid {
                    columns: 8
                    spacing: s(12)
                    anchors.horizontalCenter: parent.horizontalCenter
